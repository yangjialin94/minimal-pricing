  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex w-full max-w-3xl flex-col items-center rounded-lg bg-white bg-opacity-90 p-6 text-center shadow-lg dark:bg-gray-800 dark:bg-opacity-90 sm:p-8 md:p-10 lg:p-12 xl:p-14 2xl:p-16"
      >
        ...
        <p className="mt-2 text-[1rem] leading-relaxed text-gray-700 dark:text-gray-300 sm:text-[1.125rem] md:text-[1.25rem]">
